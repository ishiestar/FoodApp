...
import com.example.ishitasinha.foodorderingapp.AddItemsFragment.OnAddItemsInteractionListener;
import com.example.ishitasinha.foodorderingapp.data.Items;
import com.example.ishitasinha.foodorderingapp.dummy.DummyContent.DummyItem;
 ...
 * specified {@link OnAddItemsInteractionListener}.
...
public class ItemRecyclerViewAdapter extends RecyclerView.Adapter<ItemRecyclerViewAdapter.ViewHolder> {
    ...
    public ItemRecyclerViewAdapter(List<Items> items, AddItemsFragment.OnAddItemsInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
